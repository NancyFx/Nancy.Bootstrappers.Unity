...
Task("Package")
    ...
    {
        var package =
            outputPackages + File("Nancy.Bootstrappers.Unity-Latest.zip");
    ...
    .Does(() =>
    {
        ...
        else
        {
            ...
            var settings = new ProcessSettings {
                Arguments = xunit + " " + "test/Nancy.Bootstrappers.Unity.Tests/bin/"+configuration+"/net452/unix-x64/Nancy.Bootstrappers.Unity.Tests.dll"
            };
...
Task("Update-Version")
    ...
    .Does(() =>
    {
        ...
        UpdateProjectJsonVersion(version, "src/Nancy.Bootstrappers.Unity/project.json");
    });
